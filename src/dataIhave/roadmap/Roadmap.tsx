      ...
      <div className="roadmap-container">
        ...
        <section className="roadmap-hero">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              We follow a structured, step-by-step approach that mimics building
              a house—start with the foundation, add the structure, then the
              details. No skipping steps, no random tutorials, just clear
              progression.
            </p>
            <blockquote className="hero-quote">
              "Just like you wouldn't paint a house before building its
              structure, we don't teach React before mastering HTML, CSS, and
        ...
        <section className="course-section">
          <div className="course-header">
            ...
            <p className="course-subtitle">
              Before writing a single line of code, understand what you're
              working with.
            </p>
          </div>
        ...
        <section className="roadmap-cta">
          ...
          <p className="cta-subtitle">
            ...
            confusion—just clear, structured learning that leads to real
            results.
          </p>
