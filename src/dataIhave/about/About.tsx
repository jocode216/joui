      ...
      <div className="about">
        ...
        <section className="about-hero">
          <div className="about-hero-content">
            ...
            <div className="about-mission">
              ...
              <p className="about-story">
                We believe web development should be taught like building a
                house: start with the foundation, add the structure, then the
                details. No skipping steps, no random tutorials, no "magic"
                shortcuts.
              </p>
            </div>
        ...
        <section className="about-different">
          ...
          <blockquote className="about-philosophy">
            "Mastery is not a sprint; it’s a series of intentional steps. We
            don't teach you to code fast—we teach you to build well."
          </blockquote>
          ...
          <div className="about-features">
            <div className="about-feature">
              ...
              <p>
                ...
                internet, and progressing through every technology needed for
                web development.
              </p>
            </div>
            ...
            <div className="about-feature">
              ...
              <p>
                Lessons are delivered in short, focused video format with
                written equivalents. No fluff, no filler - just clear
                explanations and practical examples. Each lesson is crafted to
                be consumed in under 15 minutes while delivering maximum value.
              </p>
            </div>
        ...
        <section className="about-approach">
          ...
          <div className="approach-steps">
            <div className="approach-step">
              ...
              <p>
                Understand not just how to code, but why certain approaches
                work. We explain the underlying principles before diving into
                syntax.
              </p>
            </div>
            ...
            <div className="approach-step">
              ...
              <p>
                No skipping basics. We ensure you have rock-solid understanding
            ...
            <div className="approach-step">
              ...
              <p>
                ...
                simple HTML pages to full-stack applications with
                authentication.
              </p>
            </div>
        ...
        <section className="about-vision">
          ...
          <div className="vision-content">
            ...
            <ul className="vision-list">
              ...
              <li>
                • <strong>Website Fundamentals Course</strong>(Internet,
                Operating Systems, IDE setup, HTML, CSS, JS) - Coming Soon
              </li>
            </ul>
            ...
            <ul className="vision-list">
              <li>
                • Front-End framework(Tailwind css, React, Typescript,
                Nextjs){" "}
              </li>
        ...
        <section className="about-faq">
          ...
          <div className="faq-container">
            <div className="faq-item">
              ...
              <p>
                Absolutely! Each course allows you to preview several lessons.
                You can preview the first few modules to experience our teaching
                style.
              </p>
            </div>
        ...
        <section className="about-cta">
          ...
          <p className="cta-subtitle">
            Web development is a challenging but rewarding journey. With the
            right guidance, structure, and community, you can achieve what seems
            impossible.
          </p>
